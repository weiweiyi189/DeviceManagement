...
export class MenuService {
  private menusSubject = new BehaviorSubject<Array<Menu>>([
    ...
    new Menu({name: '转借审批', icon: 'far fa-building', url: 'approval', roles: [Menu.ROLE_MANAGER]}),
    new Menu({name: '维修审批', icon: 'far fa-building', url: 'repair', roles: [Menu.ROLE_MANAGER]}),
    new Menu({name: '报废审批', icon: 'far fa-building', url: 'scrap', roles: [Menu.ROLE_ADMIN,  Menu.ROLE_MANAGER]}),
    // tslint:disable-next-line:max-line-length
